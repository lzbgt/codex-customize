...
- Make each turn dense: complete a cluster of related tasks (prefer 5–10) including implementation + tests + docs + verification; avoid one-off micro fixes.\n\
...
- Aim for substantial progress per turn; batch 5-10 related tasks when possible and avoid tiny tweaks.\n\
- Minimum bar: deliver 5+ meaningful tasks per turn (code + tests + docs or adjacent feature work).\n\
