...
- Make each turn dense: complete a cluster of related tasks (prefer 8-14) including implementation + tests + docs + verification; avoid one-off micro fixes.\n\
- Minimum bar: deliver 8+ meaningful tasks per turn; if scope is thin, expand into adjacent tests, docs, tooling, and config hardening.\n\
- Do not end a turn after a single small fix; keep going until the bar is met or you are blocked.\n\
- Aim for at least two substantial deliverables per turn (feature or behavior changes plus tests/docs) unless blocked.\n\
...
3) Else: pick a batch of high-leverage tasks (typically 8-14) that compound and reduce future maintenance.\n\
...
- Aim for substantial progress per turn; batch 8-14 related tasks when possible and avoid tiny tweaks.\n\
- Minimum bar: deliver 8+ meaningful tasks per turn (code + tests + docs or adjacent feature work).\n\
...
- Deliver multiple substantial changes per turn (target 8-14 related tasks); do not stop after a single small change.\n\
- Aim for at least two substantial deliverables per turn unless blocked; if not possible, explain the blocker.\n\
