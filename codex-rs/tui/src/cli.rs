...
pub struct Cli {
    ...
    /// default excludes disabled. Codex applies no internal restrictions in this
    /// mode; the user accepts the risk and relies on the host security model.
    ...
    /// The follow-up prompt targets 18-24 related tasks per turn (minimum 18).
